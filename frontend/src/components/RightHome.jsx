...
// --- Main RightHome Component with Integrated Messages ---
const RightHome = () => {
  ...
  const handleBack = () => {
    // In this component, back always deselects the conversation
    setSelectedConversation(null);
  };

  return (
    // This is the key: `hidden lg:flex` makes it visible only on large screens.
    <div className="hidden lg:flex h-screen w-full max-w-sm border-l border-gray-200">
      {/* This container mimics the structure of Messages.jsx */}
