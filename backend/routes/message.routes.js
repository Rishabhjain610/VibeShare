...
// Direct Messages
MessageRouter.post("/send/:receiver", isAuth, sendMessage); // Send a direct message
...
MessageRouter.post("/groups/:groupId/members/remove", isAuth, removeUserFromGroup); // Remove a user from a group
